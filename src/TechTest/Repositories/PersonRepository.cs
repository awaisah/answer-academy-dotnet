        ...
        private static IList<Person> InMemoryCollection { get; } = new List<Person>
            {
                ...
                new Person { Id = 11, FirstName = "Willis", LastName = "Silliw", Authorised = true, Enabled = false, Colours = new List<Colour> { new Colour { Id = 1, Name = "Red" }, new Colour { Id = 2, Name = "Green" } , new Colour { Id = 3, Name = "Blue" } } },
            };
    }
}
